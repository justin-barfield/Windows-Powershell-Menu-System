...
Write-Host "`nStart MS Office 32-bit install"
...
Copy-Item -Path "$msOfficeFolder\32-bit\Setup.X86.en-us_O365ProPlusRetail_009ce7fa-26c2-410a-b331-f1e9ee5ddf0c_TX_PR_b_64_.exe" -Destination "C:\temp" -Force
...
Start-Process -FilePath "C:\temp\Setup.X86.en-us_O365ProPlusRetail_009ce7fa-26c2-410a-b331-f1e9ee5ddf0c_TX_PR_b_64_.exe" -Wait
